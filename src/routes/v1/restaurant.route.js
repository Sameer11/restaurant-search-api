 ...
 *
 *   patch:
 *     summary: Update a restaurants
 *     description: Logged in users can only update their own information. Only admins can update other restaurants.
 *     tags: [Restaurants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can delete only themselves. Only admins can delete other restaurants.
 *     tags: [Restaurants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
